    ...
    
    {
        ...
        title: 'Machinery',
        ...
        
            {
                ...
                url: 'Machiner-components'
            },
            {
                group: 'Manufacturing',
                title: 'Machinery equipment/tools',
                url: 'Machinery-equipment/tools'
            },
            {
                group: 'Manufacturing',
                title: 'Manufacture of machinery',
                url: 'Manufacture-of-machinery'
            },
            {
                group: 'Manufacturing',
                title: 'Maritime',
            ...
            {
                group: 'Manufacturing',
                title: 'Construction of metal structures',
            },
            {
                group: 'Manufacturing',
            ...
            {
                group: 'Manufacturing',
                title: 'Forgings, Fasteners',
            },
            {
                group: 'Manufacturing',
                title: 'Gas, Plasma, Laser cutting',
            },
            {
                group: 'Manufacturing',
                title: 'MIG, TIG, Aluminum welding',
            },
            ...
            {
                group: 'Manufacturing',
                title: 'Plastics welding and processing',
            },
            {
                group: 'Manufacturing',
                title: 'Plastic profiles',
            },
            {
                group: 'Manufacturing',
                title: 'Advertising',
            ...
            {
                group: 'Manufacturing',
                title: 'Book/Periodicals printing',
            },
            {
                group: 'Manufacturing',
                title: 'Labelling and packaging printing',
            },
            {
                group: 'Manufacturing',
            ...
            {
                group: 'Manufacturing',
                title: 'Wooden building materials',
            },
            {
                group: 'Manufacturing',
                title: 'Wooden houses',
            ...
            {
                group: 'Service',
                title: 'Data processing, Web portals, E-marketing',
            },
            {
                group: 'Service',
                title: 'Programming, Consultancy',
            },
            {
                group: 'Service',
